...
<?php	
  ...
  /*** To edit user **/
  function sync_sugarcrm_user_edit($user_id){
	$messages = array();
	$devOptions = $this->sync_sugarcrm_users_parameters;
	...
	$crmid = $user_meta['Sugar_ID']['0'];
	$model = $user_meta['Sugar_Class']['0'];
	
    $ret_messages = $this->sugarcrm->editCRM_user($user_info, $model,$crmid);
    $messages       = array_merge($messages, $ret_messages);
